package bj.gouv.sgg.service.extract.impl;
...
/**
 * Implémentation de l'extraction OCR conforme à l'architecture law-consolidate.
 * 
 * <p>Stratégie regex-based avec détection séquentielle d'articles.
 * Utilise {@link ArticleExtractorConfig} pour patterns depuis patterns.properties.
 * 
 * <p>Workflow :
 * <ol>
 *   <li>Extraction articles via regex patterns séquentiels</li>
 *   <li>Extraction métadonnées (titre, date, ville, signataires)</li>
 *   <li>Calcul confiance (articles, séquence, dictionnaire, termes juridiques)</li>
 * </ol>
 * 
 * <p>Clean Code :
 * - Pas de null returns (Collections.emptyList() ou exceptions)
 * - Exceptions spécifiques (OcrExtractionException)
 * - Logs structurés avec emojis
 * 
 * @see OcrExtractionService
 * @see ArticleExtractorConfig
 * @author io.law
 * @since 1.0.0
 */
@Slf4j
public class OcrExtractionServiceImpl implements OcrExtractionService {
     ...
     * 
     * <p>Score basé sur 5 critères pondérés :
     * <ul>
     *   <li>Articles extraits (20%) : min(count/10, 1.0)</li>
     *   <li>Séquentialité index (20%) : 1.0 si séquence parfaite, pénalités sinon</li>
     *   <li>Longueur texte (15%) : min(length/5000, 1.0)</li>
     *   <li>Dictionnaire (25%) : 1.0 - penalty(unrecognizedRate)</li>
     *   <li>Termes juridiques (20%) : min(legalTerms/8, 1.0)</li>
     * </ul>
     * 
     ...
     * 
     * <p>Pénalités appliquées :
     * <ul>
     *   <li>Gap (articles manquants) : -15% par gap</li>
     *   <li>Duplicate (même index répété) : -25% par duplicate</li>
     *   <li>Out-of-order (ordre inversé) : -30% par inversion</li>
     * </ul>
     * 
    ...
    private double calculateSequenceScore(List<Article> articles) {
        ...
        if (gaps > 0 || duplicates > 0 || outOfOrder > 0) {
            log.debug("Sequence quality: {} articles, {} gaps, {} duplicates, {} out-of-order → score={}",
                     articles.size(), gaps, duplicates, outOfOrder, score);
        }
