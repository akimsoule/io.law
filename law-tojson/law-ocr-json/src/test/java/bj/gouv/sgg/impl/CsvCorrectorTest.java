...
class CsvCorrectorTest {
    ...
    @Test
    void givenOcrErrorsWhenApplyCorrectionsLegalWordsCorrections() {
    ...
    @Test
    void givenEmptyTextWhenApplyCorrectionsReturnsEmptyText() {
        String input = "";
        String corrected = corrector.applyCorrections(input);
    ...
    @Test
    void givenNullTextWhenApplyCorrectionsReturnsNull() {
    ...
    @Test
    void givenCorrectTextWhenApplyCorrectionsReturnsProcessedText() {
    ...
    @Test
    void givenMultipleOccurrencesWhenApplyCorrectionsCorrectsAll() {
    ...
    @Test
    void givenPipeCharactersWhenApplyCorrectionsReplacesWithCorrectLetters() {
    ...
    @Test
    void givenArticleNumberErrorsWhenApplyCorrectionsFixesNumbering() {
    ...
    @Test
    void givenRomanNumeralErrorsWhenApplyCorrectionsFixesNumerals() {
    ...
    @Test
    void givenAeroPrefixErrorsWhenApplyCorrectionsFixesPrefixes() {
    ...
    @Test
    void givenDoubleApostrophesWhenApplyCorrectionsReplacesWithSingle() {
    ...
    @Test
    void givenCaseErrorsWhenApplyCorrectionsFixesCase() {
    ...
    @Test
    void givenComplexOcrTextWhenApplyCorrectionsProcessesAllErrors() {
        String input = """
            REPUBLIQUE DU BENIN
            LOI N° 2024-15
