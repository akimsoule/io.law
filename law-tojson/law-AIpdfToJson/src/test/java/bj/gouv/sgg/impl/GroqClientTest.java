...
class GroqClientTest {
    ...
    @Test
    void testLoadPrompt_DecretParser() throws PromptLoadException {
    ...
    @Test
    void testTransform_NoApiKey() throws Exception {
    ...
    @Test
    void testTransform_DecretDocument() throws Exception {
        Path testPdf = tempDir.resolve("test.pdf");
        Files.writeString(testPdf, "%PDF-1.4");
