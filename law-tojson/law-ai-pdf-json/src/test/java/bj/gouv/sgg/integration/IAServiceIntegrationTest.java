...
class IAServiceIntegrationTest {
    ...
    @Test
    void givenNoClientImplementationWhenCreateInstanceThenInitializesSuccessfully() {
        assertNotNull(noClient);
        assertTrue(noClient instanceof NoClient);
    }

    @Test
    void givenDifferentClientsWhenLoadPromptThenNoClientFailsOllamaSucceeds() throws Exception {
    ...
    @Test
    void givenMissingPdfFileWhenTransformThenNoClientThrowsOllamaReturnsLowConfidence() throws Exception {
    ...
    @Test
    void givenValidPdfFileWhenTransformThenNoClientThrowsOllamaProcesses() throws Exception {
    ...
    @Test
    void givenDecretDocumentWhenTransformThenUsesDecretSpecificPrompt() throws Exception {
