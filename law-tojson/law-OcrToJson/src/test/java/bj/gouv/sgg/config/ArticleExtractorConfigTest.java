...
class ArticleExtractorConfigTest {
    ...
    @Test
    void testSignatoryPatternsLoaded() {
    ...
    @Test
    void testFrenchDictionaryLoaded() {
    ...
    @Test
    void testUnrecognizedWordsRate() {
    ...
    @Test
    void testPromulgationDatePattern() {
    ...
    @Test
    void testPromulgationCityPattern() {
    ...
    @Test
    void testSignatoryPatternMatching() {
        Map<Pattern, Signatory> patterns = config.getSignatoryPatterns();
