...
class OcrExtractionServiceTest {
    ...
    @Test
    void testFullPipeline_CorrectionThenExtraction() {
        String rawOcrText = """
            REPUBLIQUE DU BENIN
            LOI N° 2024-15
    ...
    @Test
    void testExtractArticles_WithCorrections() {
    ...
    @Test
    void testExtractMetadata_AfterCorrections() {
        String rawText = """
            LOI N° 2024-15
    ...
    @Test
    void testCalculateConfidence_HighQualityAfterCorrection() {
        String rawText = """
            REPUBLIQUE DU BENIN
    ...
    @Test
    void testExtractArticles_ComplexStructure() {
        String text = """
            Article 1
    ...
    @Test
    void testExtractMetadata_CompleteDocument() {
        String text = """
            RÉPUBLIQUE DU BÉNIN
