package bj.gouv.sgg.ai.provider;

import bj.gouv.sgg.ai.provider.impl.GroqProvider;
import bj.gouv.sgg.ai.provider.impl.NoIAProvider;
import bj.gouv.sgg.ai.provider.impl.OllamaProvider;
