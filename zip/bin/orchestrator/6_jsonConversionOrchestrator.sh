...
cd "$PROJECT_ROOT"
java -jar "$JAR" --spring.config.location="file:$CONFIG" --orchestrator=jsonConversionOrchestrator --mode=once --type="$TYPE" 2>&1 | tee "$LOG_FILE"
