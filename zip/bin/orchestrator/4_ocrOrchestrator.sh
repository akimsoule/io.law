...
cd "$PROJECT_ROOT"
java -jar "$JAR" --spring.config.location="file:$CONFIG" --orchestrator=ocrOrchestrator --mode=once --type="$TYPE" 2>&1 | tee "$LOG_FILE"
